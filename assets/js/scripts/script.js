...
function getCookie(name) {
	var setPos = document.cookie.indexOf(name + '='),
		stopPos = document.cookie.indexOf(';', setPos);
...
//GOOGLE MAPS AUTOCOMPLETE FUNCTION WITH MAP - ALL CODE & COMMENTS FROM GOOGLE DEVELOPERS - SEE README//
